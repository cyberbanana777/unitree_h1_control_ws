...
*   **`cmd_to_high_level_control_package/`**: Вторая программа, анализирующая команды из **`teleop_twist_keyboard`** и приводящая Unitree H1 в необходимое движение.
