    ...
    def LowCmdWrite(self):
        ...
        if self.percent_1 < 1:
            for i in range(12):
                self.low_cmd.motor_cmd[i].q = (
                    1 - self.percent_1
                ) * self.startPos[i] + self.percent_1 * self.targetPos_1[i]
        ...
        if (self.percent_1 == 1) and (self.percent_2 <= 1):
            ...
            for i in range(12):
                self.low_cmd.motor_cmd[i].q = (
                    1 - self.percent_2
                ) * self.targetPos_1[i] + self.percent_2 * self.targetPos_2[i]
                self.low_cmd.motor_cmd[i].dq = 0
                self.low_cmd.motor_cmd[i].kp = self.Kp
                self.low_cmd.motor_cmd[i].kd = self.Kd
                self.low_cmd.motor_cmd[i].tau = 0
        ...
        if (
            ...
            for i in range(12):
                self.low_cmd.motor_cmd[i].q = (
                    1 - self.percent_4
                ) * self.targetPos_2[i] + self.percent_4 * self.targetPos_3[i]
                self.low_cmd.motor_cmd[i].dq = 0
                self.low_cmd.motor_cmd[i].kp = self.Kp
                self.low_cmd.motor_cmd[i].kd = self.Kd
                self.low_cmd.motor_cmd[i].tau = 0
